...
void main() {
  Map<String, dynamic> superHeroJson = {
    "id": 1,
    "name": "A-Bomb",
    "slug": "1-a-bomb",
    "powerstats": {
  ...
  test("verificando leitura da estrutura do json", () {
    SuperHero sh = SuperHero.fromJson(superHeroJson);

    expect(sh.toJson(), superHeroJson);
  });
}
